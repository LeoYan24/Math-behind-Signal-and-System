...
\begin{theorem}[帕塞瓦尔恒等式/普朗歇尔定理]\label{thm:distribution_plancherel}
    设$f,g\in L^1(\mathbb{R})\cap L^2(\mathbb{R})$，则
    \lr{
...
\end{lralign}
\end{proof}
相比\cref{thm:plancherel}，这个证明适用于$f$是正则分布而$g$是施瓦兹函数的情况，它的证明要简单得多。
...
因此\[f*\delta_a=\tau_a f\]
\end{example}
在\refsub{fourier_of_signal}中，我们已经从形式上得到了$\mathrm{sgn},u,1/t$，的傅里叶变换，现在有了分布的工具，就可以借助分布的傅里叶变换的对偶性说明之前的结论是严谨的。
