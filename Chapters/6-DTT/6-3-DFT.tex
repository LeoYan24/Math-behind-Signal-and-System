...
\begin{theorem}[离散傅里叶反演公式]
    ...
    \[x[n]=\mathrm{DFT}^{-1}(X[k])=\frac{1}{N}\sum_{k=0}^{N-1}X[k]W_N^{-kn},n=0,1,\dots,N-1\]
\end{theorem}
...
我们曾定义过离散信号的卷积和。类似\refsub{conv_of_period_func}，对于周期离散信号，卷积和的定义也必须修改，只是此时一般不会添加$1/N$的系数：
