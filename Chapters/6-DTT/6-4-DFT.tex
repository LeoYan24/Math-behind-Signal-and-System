...
\begin{proposition}[离散傅里叶变换的运算性质]
    ...
    \[a x[n]+b y[n]\xleftrightarrow{\mathrm{DFT}} a X[k]+b Y[k]\]
        ...
        \item 时移性质：$x[(n-n_0)]\xleftrightarrow{\mathrm{DFT}}\mathrm{e}^{-\mathrm{i}\frac{2\pi}{N}kn_0}X[k]$
        \item 频移性质：$\mathrm{e}^{\mathrm{i}\frac{2\pi}{N}k_0 n}x[n]\xleftrightarrow{\mathrm{DFT}}X\left[k-k_0\right]$
