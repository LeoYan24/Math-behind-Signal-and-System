...
\begin{definition}[因果性]
    ...
    \begin{equation}
        \forall t_0,\left(e_1(t)=e_2(t)\ \mathrm{for}\ t<t_0\right)\implies \left(r_1(t)=r_2(t)\ \mathrm{for}\ t<t_0\right)\label{eq:4.1}
    \end{equation}
...
对于线性系统，因果性条件等价于
\begin{equation}
    \forall t_0,\left(e(t)=0\ \mathrm{for}\ t<t_0\right)\implies \left(r(t)=0\ \mathrm{for}\ t<t_0\right)\label{eq:4.2}
\end{equation}
\end{proposition}
\begin{proof}
