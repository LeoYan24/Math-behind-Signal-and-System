...
数学上，激励信号，即方程的非齐次项，往往是在全时域上都存在的，但是将方程视作一个系统时，认为激励在0时刻才开始施加是合理的。这是因为$t=0$时刻的初值条件就是由$t<0$时刻的激励引起的，由于\textbf{常系数线性微分方程所描述的系统具有马尔可夫性}，有了起始条件就不再需要激励在$t<0$时刻的信息。如果我们希望考虑全时域上的非齐次项$e(t)$，将$\int_{-\infty}^0 h(s)e(t-s)\,ds$也放在响应$r(t)$的公式中，则$y_h(t)$应根据系统在“$-\infty$时刻”的零状态来确定，它当然应该是全为0的，这样，通解为：
\begin{align*}
