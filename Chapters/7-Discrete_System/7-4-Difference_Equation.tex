...
利用解的存在性与唯一性，可以仿照\refsub{solution_of_linear_equation_system}中的方法进一步说明：
\begin{theorem}
...
\end{align*}
最终，我们得到了常系数线性差分方程组的通解公式，它与\refsub{constant_coefficient_linear_equation_system}中的常系数线性微分方程组的通解公式非常相似，并且与上一小节中通过迭代法得到的通解公式一致：
\begin{theorem}
